    ...
    public void setListener(final Listener listener) {
        ...
        setOnErrorListener(new IMediaPlayer.OnErrorListener() {
            ...
            public boolean onError(IMediaPlayer iMediaPlayer, int framework_err, int impl_err) {
                ...
                String msg = getContext().getString(R.string.VideoView_error_text_unknown);
                switch (framework_err){
                    case MediaPlayer.MEDIA_ERROR_NOT_VALID_FOR_PROGRESSIVE_PLAYBACK:
                        errorType = Listener.ErrorType.INVALID_PROGRESSIVE_PLAYBACK;
                        msg = getContext().getString(R.string.VideoView_error_text_invalid_progressive_playback);
                        break;
                    case -10000:
                        errorType = Listener.ErrorType.NETWORK_ERROR;
                        msg = getContext().getString(R.string.VideoView_error_text_io);
                        break;
                }
